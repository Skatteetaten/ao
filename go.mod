module github.com/skatteetaten/ao
...
require (
	...
	github.com/skatteetaten/architect/v2 v2.6.6-alpha.3
...
require (
	...
	github.com/openshift/api v0.0.0-20200306192528-e5737622441f // indirect
