...
type gocov 2> /dev/null || go get -d github.com/axw/gocov/gocov && go install github.com/axw/gocov/gocov
type gocov-xml 2> /dev/null || go get -d github.com/AlekSi/gocov-xml && go install github.com/AlekSi/gocov-xml
